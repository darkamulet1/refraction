#!/usr/bin/env python
"""
Produce a PyJHora Rāśi (D1) chart for Arman using the standard Horoscope flow.

Run with:
    $env:PYTHONPATH = "src"
    python scripts/jhora_chart_arman.py
"""
...
BIRTH_DATE = drik.Date(1988, 9, 11)
BIRTH_TIME = "06:45:45"
LATITUDE = 35.6892
LONGITUDE = 51.3890
TIMEZONE_OFFSET_HOURS = 3.5  # Asia/Tehran on 1988-09-11
...
def main() -> None:
    ...
    print("PyJHora Rāśi Chart – Arman")
    print("-" * 40)
